...
from tensorflow.keras.layers import Dense, Dropout, Input, BatchNormalization, Conv1D, GlobalAveragePooling1D, Reshape
...
with open(metrics_file, 'w') as f:
    for lead in leads_to_predict:
        ...
        model = build_cnn_1d_model(input_shape=(X_train.shape[1], 1))
