...
if __name__ == '__main__':
    ...
    ecg_train = np.vstack(ecg_train_list + [ecg_aug])
    features_train = np.vstack(features_train_list + [features_aug])
    ...
    # Get minmax stats and remove outliers
    ...
    print("✅ Done. All cleaned datasets saved.")
